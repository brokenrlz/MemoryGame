...
public class Card {
    ...
    public static List<String> getValidSuits(){
        return Arrays.asList("diamonds","hearts", "clubs","spades");
    }

    /**
     * valid suit are "Diamonds","Hearts", "clubs","spades"
     * @param suit
     */
    ...
    public String getColour() {
        ...
        /**
         * this method returns de value of the card
    ...
    /**
     * This method will return an image that represent the Card
     */
